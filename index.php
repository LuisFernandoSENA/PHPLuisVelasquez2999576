...
<body onload="document.getElementById('usuario').focus()">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        ...
        <img src="img/cesar_logo.png" width="90" height="100">
        </a>
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="col-12 col-md-9">
                            <div class="form-outline mb-4">
                                <div class="mb-4">
                                    <div class="form-outline mb-4">
                                        <label for="cargo" class="nav-link"> &nbsp;<strong>No. Celular </strong></label>
                                            <input type="text" id="phone" class="form-control Input" name="phone" maxlength="10" required>
                                    </div>
                                </div>
                            </div>
                        </div>
